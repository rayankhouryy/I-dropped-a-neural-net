...
\bottomrule
\end{tabular}
\caption{AUROC under function-preserving laundering. P$=$permutation, D$_\mathrm{m/s}$$=$mild/strong rescaling, Lat.$=$latency (ms). Our method and Re-Basin+scale maintain AUROC$=$1.0; raw baselines collapse under rescaling. On GPT-2, ours is 76$\times$ faster than Re-Basin (5ms vs 388ms). $^\dagger$GPT-2 Weight Cosine preserves AUROC under P but scores collapse 97\% (0.977$\to$0.033); see Figure~\ref{fig:laundering-scores}.}
